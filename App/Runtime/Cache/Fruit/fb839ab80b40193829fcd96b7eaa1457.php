...
<body>
	<div data-role="page" id="pageone" data-position="fixed"> 
		<!--div data-role="header">
			<a href="/index.php/fruit/index/detail/id/<?php echo ($fruit["fruit_id"]); ?>" data-role="button" data-icon="back" data-transition="slide" data-direction="reverse">返回</a>
			<h1>评论详情</h1>
			<a href="/index.php/Fruit/Index/index" data-role="button" data-icon="home">首页</a>
		</div-->
