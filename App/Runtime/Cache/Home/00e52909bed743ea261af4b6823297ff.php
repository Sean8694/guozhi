	...
	<div data-role="page" id="pageone" data-position="fixed" style="background-color:#fff;"> 
		<div data-role="content" style="background-color:#fff;">
			<div class="home-header">
				<div><?php if($user['face'] == '0'): ?><img src="/Public/upload/my_head.gif"/><?php else: ?><img src="<?php echo ($user["face"]); ?>"/><?php endif; ?></div>
				<div class="home-header-2"><?php echo ($user["name"]); ?></div>
				<div class="home-header-3"><?php echo ($user["mobile"]); ?></div>
			</div>
			<ul class="home-list">
				<li>
					<a href="/index.php/Home/Index/myinfo">
						<img src="/Public/upload/my_zl.gif"/>	
						<h2>我的资料</h2>
						<div class='em'>></div>
						<div class='em'></div>
					</a>
				...
				<li>
					<a href="/index.php/Home/Index/orders" data-ajax="false">
						<img src="/Public/upload/my_dd.gif"/>	
				...
				<li>
					<a href="/index.php/Home/Index/wallet">
						<img src="/Public/upload/my_qb.gif"/>	
						<h2>我的钱包</h2>
						<div class='em'>></div>
					</a>
