		...
		<div data-role="content">
			<ul class="myorder-list">
				<?php if(is_array($coupons)): $key = 0; $__LIST__ = $coupons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><li>
					<a href="/zhier/index.php/Home/Index/walletCoupon/typeid/<?php echo ($vo["type_id"]); ?>" class="my-coupon-all"
					...
					<a class="my-coupon-all-more" href="/zhier/index.php/Home/Index/walletGetmore/typeid/<?php echo ($vo["type_id"]); ?>">
							获得更多 >
					</a>
