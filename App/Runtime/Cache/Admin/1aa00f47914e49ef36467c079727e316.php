...
<body>
	<div data-role="page" id="pageone" data-position="fixed"> 
		...
		<div data-role="content">
			<div data-role="navbar" >
				<ul>
				<?php if(is_array($type)): $key = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><li><a href="/zhier/index.php/Admin/Product/index/type/<?php echo ($vo["type_id"]); ?>" data-ajax="false" <?php if($typeid == $vo['type_id']): ?>class="ui-btn-active ui-state-persist"<?php endif; ?>><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
			</div>
			<ul class="fruit-list">
				<?php if(is_array($product)): $i = 0; $__LIST__ = $product;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><a href="/zhier/index.php/Admin/Product/edit/id/<?php echo ($data["fruit_id"]); ?>" data-ajax="false">
				<li>
					<img src="/zhier/Public/upload/<?php echo ($data["pic"]); ?>"/ class="admin_product_list_img">	
			...
			<a href="/zhier/index.php/Admin/Product/add" data-role="button" data-inline="true" data-theme="b" data-ajax="false">+ 添加商品</a>
		</div>
	</div> 
</body>
</html>